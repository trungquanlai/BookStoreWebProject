...
namespace ContosoUniversity.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(BookStoreContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Email,PhoneNoHome,PhoneNoWork,PhoneNoMobile,Address")] Supplier supplier)
        {
            if (id != supplier.ID)
            {
                return NotFound();
